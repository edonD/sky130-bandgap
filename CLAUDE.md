# Bandgap Reference Design Agent
...
- When stuck, search for the specific problem (e.g. "SKY130 bandgap reference startup circuit")
...
- ALWAYS verify startup from zero-current state — bandgaps have a degenerate DC point
